...
const AddProduct = () => {
  ...
  const handleBookPhotographer = (photographer) => {
    ...
    toast({
      title: "Photographer Selected",
      description: `${photographer.name} has been selected for your product photography session.`,
    });
  };
  ...
  const handleSaveProduct = () => {
    ...
    if (productImages.length === 0) {
      toast({
        ...
        description: "Please upload at least one product image or book a photographer.",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      ...
      description: "Your product has been added to your store and is pending review.",
    });
  };
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {(!formData.name || !formData.description || !formData.price || productImages.length === 0) && (
